...
INSERT INTO `sys_config` VALUES ('5', 'package', 'com.ifast.workroletype', '代码生成器配置', '2018-05-27 19:57:04', '4401');
...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COMMENT='系统日志';

-- ----------------------------
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES ('1', '1', 'admin', '登录', '159', 'POST /login', '{\"username\":[\"admin\"],\"password\":[\"1\"]}', '127.0.0.1', '2018-12-09 17:56:24');
INSERT INTO `sys_log` VALUES ('2', '1', 'admin', '删除角色', '19', 'POST /sys/role/remove', '{\"id\":[\"56\"]}', '127.0.0.1', '2018-12-09 17:56:55');
INSERT INTO `sys_log` VALUES ('3', '1', 'admin', '更新角色', '42', 'POST /sys/role/update', '{\"id\":[\"1\"],\"menuIds\":[\"193,194,195,196,197,79,80,81,83,176,177,178,179,180,20,21,22,61,12,13,14,24,25,26,15,55,56,62,74,75,76,48,72,28,29,30,57,92,98,71,78,175,1,2,6,7,73,3,77,27,91,97,1062955259346931784,-1\"],\"roleName\":[\"超级用户角色\"],\"remark\":[\"超级管理员\"]}', '127.0.0.1', '2018-12-09 18:03:32');
INSERT INTO `sys_log` VALUES ('4', '1', 'admin', '更新角色', '28', 'POST /sys/role/update', '{\"id\":[\"1\"],\"menuIds\":[\"193,194,195,196,197,79,80,81,83,176,177,178,179,180,20,21,22,61,12,13,14,24,25,26,15,55,56,62,74,75,76,48,72,28,29,30,57,92,98,71,78,175,1,2,6,7,73,3,77,27,91,97,206,-1\"],\"roleName\":[\"超级用户角色\"],\"remark\":[\"超级管理员\"]}', '127.0.0.1', '2018-12-09 18:09:43');
INSERT INTO `sys_log` VALUES ('5', '1', 'admin', '更新代码生成配置', '640', 'POST /common/generator/update', '{\"author\":[\"canxue\"],\"email\":[\"izenglong@163.com\"],\"package\":[\"com.ifast.worker\"],\"autoRemovePre\":[\"on\"],\"tablePrefix\":[\"db\"],\"tinyint\":[\"Integer\"],\"smallint\":[\"Integer\"],\"mediumint\":[\"Integer\"],\"int\":[\"Integer\"],\"integer\":[\"Integer\"],\"bigint\":[\"Long\"],\"float\":[\"Float\"],\"double\":[\"Double\"],\"decimal\":[\"BigDecimal\"],\"bit\":[\"Boolean\"],\"char\":[\"String\"],\"varchar\":[\"String\"],\"tinytext\":[\"String\"],\"text\":[\"String\"],\"mediumtext\":[\"String\"],\"longtext\":[\"String\"],\"date\":[\"Date\"],\"datetime\":[\"Date\"],\"timestamp\":[\"Date\"]}', '127.0.0.1', '2018-12-09 18:10:13');
INSERT INTO `sys_log` VALUES ('6', '1', 'admin', '根据数据表生成代码', '351', 'GET /common/generator/code/db_worker', '{}', '127.0.0.1', '2018-12-09 18:10:29');
INSERT INTO `sys_log` VALUES ('7', '1', 'admin', '根据数据表生成代码', '161', 'GET /common/generator/code/db_worker', '{}', '127.0.0.1', '2018-12-09 18:10:32');
INSERT INTO `sys_log` VALUES ('8', '1', 'admin', '根据数据表生成代码', '75', 'GET /common/generator/code/db_worker', '{}', '127.0.0.1', '2018-12-09 18:10:47');
INSERT INTO `sys_log` VALUES ('9', '1', 'admin', '根据数据表生成代码', '124', 'GET /common/generator/code/db_worker', '{}', '127.0.0.1', '2018-12-09 18:10:49');
INSERT INTO `sys_log` VALUES ('10', '1', 'admin', '根据数据表生成代码', '53', 'GET /common/generator/code/db_worker', '{}', '127.0.0.1', '2018-12-09 18:11:13');
INSERT INTO `sys_log` VALUES ('11', '1', 'admin', '根据数据表生成代码', '87', 'GET /common/generator/code/db_worker', '{}', '127.0.0.1', '2018-12-09 18:11:13');
INSERT INTO `sys_log` VALUES ('12', '1', 'admin', '根据数据表生成代码', '62', 'GET /common/generator/code/db_worker', '{}', '127.0.0.1', '2018-12-09 18:11:36');
INSERT INTO `sys_log` VALUES ('13', '1', 'admin', '根据数据表生成代码', '95', 'GET /common/generator/code/db_worker', '{}', '127.0.0.1', '2018-12-09 18:11:37');
INSERT INTO `sys_log` VALUES ('14', '1', 'admin', '登录', '93', 'POST /login', '{\"username\":[\"admin\"],\"password\":[\"1\"]}', '127.0.0.1', '2018-12-09 18:21:46');
INSERT INTO `sys_log` VALUES ('15', '1', 'admin', '根据数据表生成代码', '361', 'GET /common/generator/code/db_worker', '{}', '127.0.0.1', '2018-12-09 18:21:55');
INSERT INTO `sys_log` VALUES ('16', '1', 'admin', '更新角色', '48', 'POST /sys/role/update', '{\"id\":[\"1\"],\"menuIds\":[\"193,194,195,196,197,79,80,81,83,176,177,178,179,180,20,21,22,61,12,13,14,24,25,26,15,55,56,62,74,75,76,48,72,28,29,30,57,92,98,71,78,175,1,2,6,7,73,3,77,27,91,97,206,208,209,210,211,212,207,-1\"],\"roleName\":[\"超级用户角色\"],\"remark\":[\"超级管理员\"]}', '127.0.0.1', '2018-12-09 18:24:36');
INSERT INTO `sys_log` VALUES ('17', '1', 'admin', '根据数据表生成代码', '119', 'GET /common/generator/code/db_workrole_type', '{}', '127.0.0.1', '2018-12-09 18:24:59');
INSERT INTO `sys_log` VALUES ('18', '1', 'admin', '更新代码生成配置', '504', 'POST /common/generator/update', '{\"author\":[\"canxue\"],\"email\":[\"izenglong@163.com\"],\"package\":[\"com.ifast.workroletype\"],\"autoRemovePre\":[\"on\"],\"tablePrefix\":[\"db\"],\"tinyint\":[\"Integer\"],\"smallint\":[\"Integer\"],\"mediumint\":[\"Integer\"],\"int\":[\"Integer\"],\"integer\":[\"Integer\"],\"bigint\":[\"Long\"],\"float\":[\"Float\"],\"double\":[\"Double\"],\"decimal\":[\"BigDecimal\"],\"bit\":[\"Boolean\"],\"char\":[\"String\"],\"varchar\":[\"String\"],\"tinytext\":[\"String\"],\"text\":[\"String\"],\"mediumtext\":[\"String\"],\"longtext\":[\"String\"],\"date\":[\"Date\"],\"datetime\":[\"Date\"],\"timestamp\":[\"Date\"]}', '127.0.0.1', '2018-12-09 18:27:37');
INSERT INTO `sys_log` VALUES ('19', '1', 'admin', '根据数据表生成代码', '60', 'GET /common/generator/code/db_workrole_type', '{}', '127.0.0.1', '2018-12-09 18:27:41');
INSERT INTO `sys_log` VALUES ('20', '1', 'admin', '更新角色', '37', 'POST /sys/role/update', '{\"id\":[\"1\"],\"menuIds\":[\"193,194,195,196,197,79,80,81,83,176,177,178,179,180,20,21,22,61,12,13,14,24,25,26,15,55,56,62,74,75,76,48,72,28,29,30,57,92,98,208,209,210,211,212,71,78,175,1,2,6,7,73,3,77,27,91,97,207,213,214,215,216,217,218,206,-1\"],\"roleName\":[\"超级用户角色\"],\"remark\":[\"超级管理员\"]}', '127.0.0.1', '2018-12-09 18:29:09');
...
INSERT INTO `sys_menu` VALUES ('206', '0', '角色管理', '', '', '0', 'fa fa-address-book', null, null, null);
INSERT INTO `sys_menu` VALUES ('207', '206', '员工管理', '/worker/worker', null, '1', 'fa fa-file-code-o', '6', null, null);
INSERT INTO `sys_menu` VALUES ('208', '207', '查看', null, 'worker:worker:worker', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('209', '207', '新增', null, 'worker:worker:add', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('210', '207', '修改', null, 'worker:worker:edit', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('211', '207', '删除', null, 'worker:worker:remove', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('212', '207', '批量删除', null, 'worker:worker:batchRemove', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('213', '206', '员工角色管理', '/workroletype/workroleType', null, '1', 'fa fa-file-code-o', '6', null, null);
INSERT INTO `sys_menu` VALUES ('214', '213', '查看', null, 'workroletype:workroleType:workroleType', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('215', '213', '新增', null, 'workroletype:workroleType:add', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('216', '213', '修改', null, 'workroletype:workroleType:edit', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('217', '213', '删除', null, 'workroletype:workroleType:remove', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('218', '213', '批量删除', null, 'workroletype:workroleType:batchRemove', '2', null, '6', null, null);
...
CREATE TABLE `sys_role_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5496 DEFAULT CHARSET=utf8 COMMENT='角色与菜单对应关系';
...
INSERT INTO `sys_role_menu` VALUES ('5430', '1', '193');
INSERT INTO `sys_role_menu` VALUES ('5431', '1', '194');
INSERT INTO `sys_role_menu` VALUES ('5432', '1', '195');
INSERT INTO `sys_role_menu` VALUES ('5433', '1', '196');
INSERT INTO `sys_role_menu` VALUES ('5434', '1', '197');
INSERT INTO `sys_role_menu` VALUES ('5435', '1', '79');
INSERT INTO `sys_role_menu` VALUES ('5436', '1', '80');
INSERT INTO `sys_role_menu` VALUES ('5437', '1', '81');
INSERT INTO `sys_role_menu` VALUES ('5438', '1', '83');
INSERT INTO `sys_role_menu` VALUES ('5439', '1', '176');
INSERT INTO `sys_role_menu` VALUES ('5440', '1', '177');
INSERT INTO `sys_role_menu` VALUES ('5441', '1', '178');
INSERT INTO `sys_role_menu` VALUES ('5442', '1', '179');
INSERT INTO `sys_role_menu` VALUES ('5443', '1', '180');
INSERT INTO `sys_role_menu` VALUES ('5444', '1', '20');
INSERT INTO `sys_role_menu` VALUES ('5445', '1', '21');
INSERT INTO `sys_role_menu` VALUES ('5446', '1', '22');
INSERT INTO `sys_role_menu` VALUES ('5447', '1', '61');
INSERT INTO `sys_role_menu` VALUES ('5448', '1', '12');
INSERT INTO `sys_role_menu` VALUES ('5449', '1', '13');
INSERT INTO `sys_role_menu` VALUES ('5450', '1', '14');
INSERT INTO `sys_role_menu` VALUES ('5451', '1', '24');
INSERT INTO `sys_role_menu` VALUES ('5452', '1', '25');
INSERT INTO `sys_role_menu` VALUES ('5453', '1', '26');
INSERT INTO `sys_role_menu` VALUES ('5454', '1', '15');
INSERT INTO `sys_role_menu` VALUES ('5455', '1', '55');
INSERT INTO `sys_role_menu` VALUES ('5456', '1', '56');
INSERT INTO `sys_role_menu` VALUES ('5457', '1', '62');
INSERT INTO `sys_role_menu` VALUES ('5458', '1', '74');
INSERT INTO `sys_role_menu` VALUES ('5459', '1', '75');
INSERT INTO `sys_role_menu` VALUES ('5460', '1', '76');
INSERT INTO `sys_role_menu` VALUES ('5461', '1', '48');
INSERT INTO `sys_role_menu` VALUES ('5462', '1', '72');
INSERT INTO `sys_role_menu` VALUES ('5463', '1', '28');
INSERT INTO `sys_role_menu` VALUES ('5464', '1', '29');
INSERT INTO `sys_role_menu` VALUES ('5465', '1', '30');
INSERT INTO `sys_role_menu` VALUES ('5466', '1', '57');
INSERT INTO `sys_role_menu` VALUES ('5467', '1', '92');
INSERT INTO `sys_role_menu` VALUES ('5468', '1', '98');
INSERT INTO `sys_role_menu` VALUES ('5469', '1', '208');
INSERT INTO `sys_role_menu` VALUES ('5470', '1', '209');
INSERT INTO `sys_role_menu` VALUES ('5471', '1', '210');
INSERT INTO `sys_role_menu` VALUES ('5472', '1', '211');
INSERT INTO `sys_role_menu` VALUES ('5473', '1', '212');
INSERT INTO `sys_role_menu` VALUES ('5474', '1', '71');
INSERT INTO `sys_role_menu` VALUES ('5475', '1', '78');
INSERT INTO `sys_role_menu` VALUES ('5476', '1', '175');
INSERT INTO `sys_role_menu` VALUES ('5477', '1', '1');
INSERT INTO `sys_role_menu` VALUES ('5478', '1', '2');
INSERT INTO `sys_role_menu` VALUES ('5479', '1', '6');
INSERT INTO `sys_role_menu` VALUES ('5480', '1', '7');
INSERT INTO `sys_role_menu` VALUES ('5481', '1', '73');
INSERT INTO `sys_role_menu` VALUES ('5482', '1', '3');
INSERT INTO `sys_role_menu` VALUES ('5483', '1', '77');
INSERT INTO `sys_role_menu` VALUES ('5484', '1', '27');
INSERT INTO `sys_role_menu` VALUES ('5485', '1', '91');
INSERT INTO `sys_role_menu` VALUES ('5486', '1', '97');
INSERT INTO `sys_role_menu` VALUES ('5487', '1', '207');
INSERT INTO `sys_role_menu` VALUES ('5488', '1', '213');
INSERT INTO `sys_role_menu` VALUES ('5489', '1', '214');
INSERT INTO `sys_role_menu` VALUES ('5490', '1', '215');
INSERT INTO `sys_role_menu` VALUES ('5491', '1', '216');
INSERT INTO `sys_role_menu` VALUES ('5492', '1', '217');
INSERT INTO `sys_role_menu` VALUES ('5493', '1', '218');
INSERT INTO `sys_role_menu` VALUES ('5494', '1', '206');
INSERT INTO `sys_role_menu` VALUES ('5495', '1', '-1');
